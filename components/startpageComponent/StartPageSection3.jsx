    ...
    <Container className={classes.container}>
      <Grid container className={classes.cardContainer}>
        ...
        <Grid item>
          <CardComponent
            header="Domene"
            text=" Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis asperiores sint dicta, quis vero beatae perspiciatis corrupti quidem nihil doloremque quod suscipit nostrum? Libero, rem? Voluptates aspernatur nihil minima praesentium. "
            icon={
              <PublicIcon
